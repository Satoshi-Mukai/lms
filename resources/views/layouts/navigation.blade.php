    ...
    <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ Auth::check() && Auth::user()->is_admin ? route('admin.dashboard') : route('user.dashboard') }}">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="Auth::check() && Auth::user()->is_admin ? route('admin.dashboard') : route('user.dashboard')" :active="request()->routeIs('dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    </div>
                </div>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="Auth::check() && Auth::user()->is_admin ? route('admin.dashboard') : route('user.dashboard')" :active="request()->routeIs('dashboard')">
                    {{ __('Dashboard') }}
